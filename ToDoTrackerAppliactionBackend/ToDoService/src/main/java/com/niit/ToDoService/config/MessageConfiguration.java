...
public class MessageConfiguration {
    private String exchangeName="archive_exchange";
    private String registerQueue="archive_queue";
    ...
    {
        return BindingBuilder.bind(registerQueue()).to(exchange).with("archive_routing");
    }
