...
public class ArchiveRepositoryTest {
    ...
    private Task task;
    private Task task2;
    private List<Task> officialTaskList,personalTaskList;
    @BeforeEach
    public void setUp() {
        java.util.Date dt = convertionOfdate("2022-03-21");
        archive = new Archive(1,"saisandeep@gmail.com",officialTaskList,personalTaskList);
        ...
        officialTaskList=new ArrayList<>(Arrays.asList(task));
        personalTaskList=new ArrayList<>(Arrays.asList(task2));
    }
