...
public class ArchiveControllerTest {
    ...
    public void setUp() {
        ...
        archive1 = new Archive(1, "saisandeep@gmail.com", taskList1,taskList2);
        archive2 = new Archive(1, "saisandeep@gmail.com", taskList2,taskList3);
        archive3 = new Archive(1, "saisandeep@gmail.com", taskList3,taskList1);
...
//        when(archiveService.saveArchive(any(),anyString())).thenReturn(archive1);
//        mockMvc.perform(post("/archiveservice/archive")
//                        .contentType(MediaType.APPLICATION_JSON)
//                        .content(jsonToString(archive1)))
//                .andExpect(status().isCreated())
//                .andDo(MockMvcResultHandlers.print());
//        verify(archiveService, times(1)).saveArchive(any(),anyString());
//    }
//
//    @Test
//    public void saveContentDetailsNegativeTest() throws Exception {
//        when(archiveService.saveArchive(any(),a)).thenThrow(ArchiveAlreadyExistsException.class);
//        mockMvc.perform(post("/archiveservice/archive")
//                        .contentType(MediaType.APPLICATION_JSON)
...
//        when(archiveService.saveOfficialTaskToArchive(anyString(),any())).thenReturn(archive1);
//        mockMvc.perform(post("/archiveservice/archive/saisandeep@gmail.com")
//                        .contentType(MediaType.APPLICATION_JSON)
//                        .content(jsonToString(archive1)))
//                .andExpect(status().isCreated())
//                .andDo(MockMvcResultHandlers.print());
//        verify(archiveService, times(1)).saveOfficialTaskToArchive(anyString(),any());
//    }
//
//    @Test
...
//    }
    ...
    @Test
    public void getOfficialTasklistByUserEmailPositiveTest() throws Exception {
        when(archiveService.getOfficialTasklistByUserEmail(anyString())).thenReturn(taskList1);
        mockMvc.perform(get("/archiveservice/archive/officialTask/saisandeep@gmail.com")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(jsonToString(archive1)))
                .andExpect(status().isOk())
                .andDo(MockMvcResultHandlers.print());
        verify(archiveService, times(1)).getOfficialTasklistByUserEmail(anyString());
    }

    @Test
    public void getOfficialTasklistByUserEmailNegativeTest() throws Exception {
        when(archiveService.getOfficialTasklistByUserEmail(anyString())).thenThrow(ArchiveNotFoundException.class);
        mockMvc.perform(get("/archiveservice/archive/officialTask/saisandeep@gmail.com")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(jsonToString(archive)))
                .andExpect(status().isNotFound())
    ...
    @Test
    public void getPersonalTasklistByUserEmailPositiveTest() throws Exception {
        when(archiveService.getPersonalTasklistByUserEmail(anyString())).thenReturn(taskList1);
        mockMvc.perform(get("/archiveservice/archive/personalTask/saisandeep@gmail.com")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(jsonToString(archive1)))
                .andExpect(status().isOk())
                .andDo(MockMvcResultHandlers.print());
        verify(archiveService, times(1)).getPersonalTasklistByUserEmail(anyString());
    }

    @Test
    public void getPersonalTasklistByUserEmailNegativeTest() throws Exception {
        when(archiveService.getPersonalTasklistByUserEmail(anyString())).thenThrow(ArchiveNotFoundException.class);
        mockMvc.perform(get("/archiveservice/archive/personalTask/saisandeep@gmail.com")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(jsonToString(archive)))
                .andExpect(status().isNotFound())
